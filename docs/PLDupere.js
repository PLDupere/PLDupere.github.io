$(document).ready(function() {
    $("#Home").click(function(){
        ...
        $("#Text5").text("Après avoir réfléchi à mon parcours académique et professionnel futur, j'ai pris la décision de me spécialiser dans le domaine de l'informatique. Je suis convaincu que les compétences acquises dans ce domaine seront très utiles pour mon avenir professionnel.");
      });
      //-------------------------------------------------------------------------------------------------------------------------
      $("#Avatar").click(function(){
        var answer = prompt("Un peu de sport cérébral !?! \u000A si : 2 + 3 = 10 \u000A 7 + 2 = 63 \u000A 6 + 5 = 66 \u000A 8 + 4 = 96 \u000A Nous aurons donc : \u000A 9 + 7 = ?");
        if (answer == 144) {
          alert("https://doc.lagout.org/");
        }else{
      ...
      $("#Formation").click(function(){
        ...
        //Ligne1_B
        $("#L1_2H").text("Université du Québec à Rimouski");
      ...
      $("#Experience").click(function(){
        ...
        $("#L1_1T").text("Technicien automatisation");
        $("#L1_1B").text("");
        ...
        $("#L1_2T").text("Technicien communication et sighaux");
        $("#L1_2B").text("");
        ...
        "Vérifier que les équipements soit conforment aux shémas électriques", 
        ...
        $("#L2_1T").text("Technicien en électricité ");
        $("#L2_1B").text("");
        const ffs = ["Mise à exécution des notions d’apprentissages typiques de la réalité du métier via des stages et emploi ", 
        ...
        "Tâches administratives au manège militaire" 
        ];
      ...
      $("#Qualification").click(function(){
        ...
        $("#L1_2L").attr("href","https://www.red-seal.ca/trades/c.4nst_.2l.2ctr.3c-fra.html");
         ...
         for (let i = 0; i < rsIndustriel.length; i++) {
          ...
          //Ligne2_B
          $("#L2_2H").text("Mobius Institute");
          $("#L2_2I").attr("src","./img/Organisations/mobius.png")
          $("#L2_2T").text("Certificat de formation Analyse de vibration");
          $("#L2_2B").text("");
          ...
          $("#L2_2L").attr("href","https://www.mobiusinstitute.com/certification-requirements/");
        //Ligne3_A
         ...
         //Ligne3_B
         $("#L3_2H").text("Conseil canadien des directeurs de l’apprentissage");
         $("#L3_2I").attr("src","./img/Organisations/sceauRouge.jpg")
         $("#L3_2T").text("Technicien instrumentation et contrôle (2243)");
         $("#L3_2B").text("");
         ...
         $("#L3_2L").attr("href","https://www.red-seal.ca/trades/.3ct-fra.html");
         //Ligne4_A
      ...
      $("#Information").click(function(){
        ...
        $("#Text4").text("");
        $("#Text5").text("");
        $("#Text1").text("Je suis à votre disposition pour toute information complémentaire et je serais ravi de vous rencontrer pour discuter de mes compétences et de mes aspirations professionnelles.");
        $("#Text2").text("");
        $("#Text3").text("");
        $("#Text4").text("");
        $("#Text5").text("Cordialement :) ");
      }); 
    //-----
})